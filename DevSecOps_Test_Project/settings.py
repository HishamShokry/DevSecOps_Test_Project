"""
Django settings for DevSecOps_Test_Project project.
...
SECRET_KEY = 'django-insecure-6zm6b8d*6*yb$$ewgthb*ytml8(u*mp0m#-1_$7yesi1^ylw8p'
...
WSGI_APPLICATION = 'DevSecOps_Test_Project.wsgi.application'
